...
export default function HomePage() {
  ...
  return (
    <>
            ...
            <ScrollReveal delay={100}>
              <div className="glass-effect rounded-3xl p-10 md:p-12 shadow-soft-lg border-2 border-sea-sage/30 bg-gradient-to-br from-warm-linen to-pebble">
                <h3 className="text-2xl md:text-3xl font-bold text-sea-sage mb-6">
                  The Architect and The Engine: A Data-Driven Manifesto
                </h3>
                <p className="text-base md:text-lg leading-8 text-body mb-8">
                  The complete intellectual and clinical foundation of The Anxiety Protocol. This is the definitive report on the failures of the old model and the new architecture we engineered to replace it.
                </p>
                <Link
      ...
      {/* SECTION 3: DIAGNOSIS OF THE OLD MODEL'S DESIGN FLAWS */}
      <section className="py-16 md:py-20">
        <Container>
          <div className="max-w-6xl mx-auto">
            <ScrollReveal>
              <h2 className="text-2xl md:text-3xl font-bold text-sea-sage mb-8 text-center">
      ...
      {/* SECTION 4: REQUIRED READING FROM THE BRIEFING ROOM */}
