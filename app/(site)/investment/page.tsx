      ...
      <Container>
        ...
        <section className="mb-16 max-w-4xl mx-auto">
          ...
          <ScrollReveal delay={150}>
            ...
            <div className="glass-effect rounded-3xl p-6 md:p-8 shadow-soft-lg border border-dune-shadow overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b-2 border-dune-shadow">
                    <th className="py-4 px-4 text-sea-sage font-bold">Feature</th>
                    <th className="py-4 px-4 text-sea-sage font-bold">The Anxiety Protocol</th>
                    <th className="py-4 px-4 text-sea-sage font-bold">Traditional Therapy</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-dune-shadow/50">
                  <tr>
                    <td className="py-4 px-4 font-medium text-sea-sage">Total Investment</td>
                    <td className="py-4 px-4 text-body"><strong className="text-sea-sage">£2,500 (Fixed)</strong></td>
                    <td className="py-4 px-4 text-body"><strong className="text-sea-sage">£4,000 - £15,000+ (Variable)</strong></td>
                  </tr>
                  <tr>
                    <td className="py-4 px-4 font-medium text-sea-sage">Timeline</td>
                    <td className="py-4 px-4 text-body"><strong className="text-sea-sage">30-Day Intensive (Defined)</strong></td>
                    <td className="py-4 px-4 text-body"><strong className="text-sea-sage">12-24+ Months (Indefinite)</strong></td>
                  </tr>
                  <tr>
                    <td className="py-4 px-4 font-medium text-sea-sage">Outcome</td>
                    <td className="py-4 px-4 text-body"><strong className="text-sea-sage">A Measurable Result & the Tools for Autonomy</strong></td>
                    <td className="py-4 px-4 text-body"><strong className="text-sea-sage">Uncertain, Vague Exploration, Potential Dependency</strong></td>
                  </tr>
                  <tr>
                    <td className="py-4 px-4 font-medium text-sea-sage">Dosage</td>
                    <td className="py-4 px-4 text-body"><strong className="text-sea-sage">The Equivalent of 15+ Sessions/Week</strong></td>
                    <td className="py-4 px-4 text-body"><strong className="text-sea-sage">1 Session/Week (Neurologically Insignificant)</strong></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <ScrollReveal delay={200}>
            ...
            <ul className="space-y-6 text-lg leading-8 text-body">
              <li className="flex items-start">
                ...
                <div>
                  <strong className="text-sea-sage">A System Upgrade:</strong> A re-engineered nervous system that responds to stress with calibrated control, not a chaotic hijack.
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-sea-sage mr-3 flex-shrink-0 mt-1">•</span>
                <div>
                  <strong className="text-sea-sage">A Permanent Toolkit:</strong> The complete set of Somatic Drills and cognitive tools to handle future challenges independently.
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-sea-sage mr-3 flex-shrink-0 mt-1">•</span>
                <div>
                  <strong className="text-sea-sage">A User's Manual for Your Mind:</strong> Your personal "Anxiety Blueprint" and "Go-Forward Plan," giving you the data to be your own expert.
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-sea-sage mr-3 flex-shrink-0 mt-1">•</span>
                <div>
                  <strong className="text-sea-sage">A Reclaimed Future:</strong> The elimination of the opportunity cost and the freedom to pursue the life your anxiety was preventing.
                </div>
              </li>
            </ul>
          </ScrollReveal>
